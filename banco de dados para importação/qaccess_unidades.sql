...
CREATE TABLE `unidades` (
  `idunidade` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `condominio` varchar(250) CHARACTER SET utf8mb3 COLLATE utf8_unicode_ci DEFAULT NULL,
  `cep` int DEFAULT NULL,
  `numero` int DEFAULT NULL,
  `bloco` varchar(5) CHARACTER SET utf8mb3 COLLATE utf8_unicode_ci DEFAULT NULL,
